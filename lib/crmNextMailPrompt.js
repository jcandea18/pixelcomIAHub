...
export function buildCrmNextMailMessages(contact, brief) {
...
Referencia de líneas y productos Pixelcom (usa solo lo pertinente al contacto): ${PIXELCOM_OFFERING_SHORT_ES}
