...
export function buildCrmEnrichUserPrompt(contact) {
  const lines = [
    ...
    '',
    'Instrucción operativa: primero usa la herramienta de búsqueda web disponible para contrastar datos públicos recientes sobre la empresa y el rol del contacto; después devuelve ÚNICAMENTE el objeto JSON del esquema (sin texto previo ni posterior).',
    '',
